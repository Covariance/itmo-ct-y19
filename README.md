...
* Для этого нужно измнить функцию `staticfs_get_inode`
...
Добавьте директорию `netdir` в корень ФС, список файлов в которой будет читаться с сервера. Никакие операции с файлами внутри можно не поддерживать.
